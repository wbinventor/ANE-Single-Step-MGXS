...
\hypersetup{colorlinks=true,
  pdftitle={A Single-Step Framework to Generate Spatially Self-Shielded Multi-Group Cross Sections from Monte Carlo Transport Simulations},
...
\footnotetext{This author was a graduate research assistant at the Massachusetts Institute of Technology at the time this research was conducted. The author's affiliation with The MITRE Corporation is provided for identification purposes only, and is not intended to convey or imply MITRE's concurrence with, or support for, the positions, opinions or viewpoints expressed by the author. Approved for Public Release and Distribution Unlimited Case 18-2677.}
